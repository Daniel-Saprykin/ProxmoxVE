...
ADDON_SCRIPT="https://raw.githubusercontent.com/Daniel-Saprykin/ProxmoxVE/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Daniel-Saprykin/ProxmoxVE/main/tools/addon/coolify.sh)"
MIGRATION_EOF
