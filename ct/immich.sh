...
function update_script() {
  ...
  if [[ -f /etc/apt/sources.list.d/immich.list ]]; then
    ...
    msg_error "Please visit https://github.com/Daniel-Saprykin/ProxmoxVE/discussions/7726 for details."
    echo "${TAB3}  If you have upgraded your LXC to Trixie and you still see this message, please open an Issue in the Daniel-Saprykin repo."
    exit
  fi
