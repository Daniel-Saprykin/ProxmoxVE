...
ADDON_SCRIPT="https://raw.githubusercontent.com/Daniel-Saprykin/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Daniel-Saprykin/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
